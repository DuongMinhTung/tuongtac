        ...
        <div class="col-lg-6">
          <div class="intro_content">
            <div class="section_title">
              <div>Xin chàp</div>
              <h1>Căn phòng tuyệt vời trước biển</h1>
            </div>
            <div class="intro_text">
              <p>Các nhà phát triển lớn nhất của Maecenas quan tâm. Malesuada mùa bóng đá nhưng đã đánh bại. Donec pharetra mattis nulla, id laoreet neque vitae tại. Trong không ligula consectetur ultrices quis augue Quisque eget sem. Sư tử cho đến khi macro descryed không hoàn hảo cần nó, Liệt kê các quả bóng đậu phộng. Trò chuyện tại khối bóng đá lớn nhất như con đường chăm sóc cổ họng. Malesuada mùa bóng đá nhưng đã đánh bại. Donec pharetra mattis nulla, id laoreet ở một vị trí để phán xét, cũng không phải của sự gian ác. Trong không ligula consectetur ultrices quis augue Quisque eget sem. Sư tử cần tài cho đến khi nhiệt độ, Liệt kê quả bóng lạc. Trò chuyện bóng đá hàng loạt tại trang web.</p>
            </div>
      ...
      <div class="row">
        <div class="col">
          <div class="section_title text-center">
            <div>Resort</div>
            <h1>Những gì chúng tôi cung cấp</h1>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Bể bơi ngoài trời</h3></div>
